...
async def get_alert_rules():
    ...
    try:
        ...
        return APIResponse(success=True, data={"rules": rules_info}, message="Alert rules retrieved successfully")
    except Exception as e:
...
async def get_detailed_health():
    ...
    try:
        ...
        is_healthy = (
            ...
            and system_metrics["disk_percent"] < 95
        )

        return APIResponse(success=is_healthy, data=health_data, message="Detailed health check completed")
    except Exception as e:
...
async def get_top_endpoints(limit: int = 10):
    ...
    try:
        ...
        return APIResponse(
            success=True, data={"endpoints": top_endpoints}, message="Top endpoints retrieved successfully"
        )
    except Exception as e:
...
async def get_alert_history(hours: int = 24):
    ...
    try:
        ...
        return APIResponse(
            success=True, data={"alerts": alert_history, "hours": hours}, message="Alert history retrieved successfully"
        )
    except Exception as e:
...
async def silence_alert(rule_name: str, duration_minutes: int = 30):
    ...
    try:
        ...
        return APIResponse(success=True, message=f"Alert rule '{rule_name}' silenced for {duration_minutes} minutes")
    except Exception as e:
...
async def get_dashboard_metrics():
    ...
    try:
        ...
        return APIResponse(success=True, data=dashboard_data, message="Dashboard metrics retrieved successfully")
    except Exception as e:
