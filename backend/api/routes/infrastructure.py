...
async def get_infrastructure_dashboard():
    ...
    try:
        ...
        return APIResponse(
            ...
            message="Infrastructure dashboard data retrieved successfully"
        )
...
async def get_detailed_resource_usage():
    ...
    try:
        ...
        return APIResponse(
            success=True,
            data=detailed_usage,
            message="Detailed resource usage retrieved successfully"
        )
    except Exception as e:
...
async def get_cluster_nodes():
    ...
    try:
        ...
        return APIResponse(
            success=True,
            data=cluster_stats,
            message="Cluster nodes information retrieved successfully"
        )
    except Exception as e:
...
async def drain_cluster_node(node_id: str):
    ...
    try:
        ...
        return APIResponse(
            success=True,
            message=f"Node '{node_id}' set to draining mode"
        )
    except Exception as e:
