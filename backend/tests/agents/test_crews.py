...
def patch_abstract():
    ...
    with patch.object(
        __import__("backend.agents.base_agent", fromlist=["BaseAgent"]).BaseAgent, "__abstractmethods__", frozenset()
    ):
        yield
...
class TestCEOCrew:
    ...
    @pytest.mark.asyncio
    async def test_make_strategic_decision(self, mock_task_class, mock_crew_class, mock_agent_class):
        ...
        context = {"project_state": "In Progress", "options": ["Option A", "Option B"], "constraints": ["Budget limit"]}
    ...
    @patch("backend.agents.crews.ceo_crew.Task")
    @pytest.mark.asyncio
    async def test_make_strategic_decision_empty_context(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.ceo_crew.Task")
    @pytest.mark.asyncio
    async def test_review_project_status(self, mock_task_class, mock_crew_class, mock_agent_class):
        ...
        project_data = {"name": "Test Project", "status": "Active", "progress": 75, "issues": ["Issue 1", "Issue 2"]}
    ...
    @patch("backend.agents.crews.ceo_crew.Task")
    @pytest.mark.asyncio
    async def test_review_project_status_empty_data(self, mock_task_class, mock_crew_class, mock_agent_class):
...
class TestEngineeringCrew:
    ...
    @pytest.mark.asyncio
    async def test_implement_feature(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_implement_feature_empty_spec(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_review_code(self, mock_task_class, mock_crew_class, mock_agent_class):
        """Test reviewing code."""
        from backend.agents.crews.engineering_crew import EngineeringCrew
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_review_code_without_context(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_review_code_long_code(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_create_tests_unit(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_create_tests_integration(self, mock_task_class, mock_crew_class, mock_agent_class):
    ...
    @patch("backend.agents.crews.engineering_crew.Task")
    @pytest.mark.asyncio
    async def test_create_tests_default_type(self, mock_task_class, mock_crew_class, mock_agent_class):
...
class TestPlanningCrew:
    ...
    def test_create_planning_crew(self, mock_crew_class, mock_pm_role, mock_ceo_role, mock_get_router):
...
class TestDesignCrew:
    ...
    def test_create_design_crew(
        self, mock_crew_class, mock_pm_role, mock_architect_role, mock_ceo_role, mock_get_router
    ):
...
class TestImplementationCrew:
    ...
    def test_create_implementation_crew(
        self, mock_crew_class, mock_pm_role, mock_frontend_role, mock_backend_role, mock_architect_role, mock_get_router
    ):
...
class TestDeploymentCrew:
    ...
    def test_create_deployment_crew(
        self, mock_crew_class, mock_backend_role, mock_architect_role, mock_devops_role, mock_get_router
    ):
