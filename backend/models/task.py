...
class Task(BaseModel):
    ...
    workflow_id: Optional[str] = Field(default=None, description="Parent workflow ID")
    ...
    crew_type: Optional[str] = Field(default=None, description="Crew type for execution")
